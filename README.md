...
**Branch:** `feature/forge-assistant` · version `0.3.0-forge-assistant-dev`  
...
- Tag target: `v0.3.0-forge-assistant-dev` (published with this wave)
...
## What works in 0.3.0-forge-assistant-dev
...
- Privacy-first TTS (off by default, empty allowlist, quiet hours, never persists bodies)
